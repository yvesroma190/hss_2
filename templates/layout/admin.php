...
<head>
  ...
  <title>HSS-ADMINISTRATION</title>
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href=<?= $this->Url->build(['controller'=>'Souscriptions', 'action'=>'index']) ?>>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href=<?= $this->Url->build(['controller'=>'Users', 'action'=>'index']) ?> >Utilisateurs</a>
            <a class="collapse-item" href=<?= $this->Url->build(['controller'=>'Usergroups', 'action'=>'index']) ?> >Groupes</a>
          </div>
        </div>
      </li>
