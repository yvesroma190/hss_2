...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $souscriptiontele->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $souscriptiontele->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="souscriptionteles form content">
            ...
            <fieldset>
                <legend><?= __('Edit Souscriptiontele') ?></legend>
                <?php
